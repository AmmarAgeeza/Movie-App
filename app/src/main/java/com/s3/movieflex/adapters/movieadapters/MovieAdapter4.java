...
public class MovieAdapter4 extends RecyclerView.Adapter<MovieAdapter4.ViewHolder> {
    ...
    public MovieAdapter4(Context context, ArrayList<MovieModel> fList, MovieItemClickListener listener) {
        MovieAdapter4.fList = fList;
