...
public class MovieAdapter5 extends RecyclerView.Adapter<MovieAdapter5.ViewHolder> {
    ...
    public MovieAdapter5(Context context, ArrayList<MovieModel> fList, MovieItemClickListener listener) {
        MovieAdapter5.fList = fList;
