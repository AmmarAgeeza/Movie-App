...
public class MovieAdapter6 extends RecyclerView.Adapter<MovieAdapter6.ViewHolder> {
    ...
    public MovieAdapter6(Context context, ArrayList<MovieModel> fList, MovieItemClickListener listener) {
        MovieAdapter6.fList = fList;
